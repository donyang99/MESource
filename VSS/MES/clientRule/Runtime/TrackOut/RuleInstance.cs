...
//1. search TrackOut and replace to your <RuleName>
    ...
    public class RuleInstance : idv.mesCore.mesClientRule
    {
        ...
        public override bool PreExecute()
        {
            for (int i = 0; i < RuleInstance.ItemCount; i++)
            {
                ...
                if (!lot.isDispatching || lot.status != idv.mesCore.WIP.LotStatus.RUN.ToString())
                    return false;
            }
            return true;
        }
        ...
        static mesClientRule _clientRule = null;
