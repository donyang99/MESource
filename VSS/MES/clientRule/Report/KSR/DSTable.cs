...
namespace ClientRule.KSR
{
    public class ColumnSetting
    {
        ...
        public ColumnSetting(int width,HorizontalAlign align,HorizontalAlign captionAlign,string format)
        {
            Width = width;
            HAlign = align;
    ...
    {        
        ...
        public void AddColumnSetting(ColumnSetting columnSetting, bool accumulation)
        {
        ...
        public void AddColumnSetting(ColumnSetting columnSetting)
        {
            AddColumnSetting(columnSetting, false);
        }
        ...
        public string Render(System.Data.DataTable dt)
        {
            ...
            for (int i = 0; i < Captions.Count; i++)
            {
                ...
                {
                    ColumnSetting cs = columnSettings[j];
                    ...
                    if (prevText == cs.Value)
                    {
                        if (tc.ColumnSpan == 0)
                            tc.ColumnSpan = 1;
                        tc.ColumnSpan++;
                        columnSettings[j].TestWidth(prevText);
                        tc.Width = (int)(tc.Width.Value + columnSettings[j].Width);
                    }
                    else if (merge)
                    {
                    ...
                    else
                    {
                        ...
                        tc.Text = caption[j];
                        tc.BorderWidth = 1;
                        tc.HorizontalAlign = columnSettings[j].CaptionHAlign;
                        columnSettings[j].TestWidth(tc.Text);
                        tc.Width = columnSettings[j].Width;
                        tr.Cells.Add(tc);
                        cs.tableCell = tc;
                    }
                    prevText = caption[j];
