...
//1. search EqSetupMaterial and replace to your <RuleName>
...
//   3.2 Default namespace toClientRule.<RuleName>
//4. implement idv.mesCore.mesMESRules properties in this Class
...
namespace ClientRule.EqSetupMaterial
{
    public class RuleInstance : idv.mesCore.mesClientRule
    {
        ...
        {
            get { return "EQP"; }//RunTime Rule的ruleCategory回傳空白(不會顯示在Client的Rule選單上)
        }
        /// <summary>
        ...
        public static Equipment GetItem(int index)
        {
            if (_clientRule != null)
                return (Equipment)_clientRule.getItem(index);
            return null;
        }
