...
namespace ClientRule.ResetState
{
    public partial class frmMain : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            mesRelease.EQP.Txn.Reset txn = new mesRelease.EQP.Txn.Reset();
            txn.txnUser = User.loginUser.name;
            txn.resetCounter = rdoYes.Checked;
        ...
        bool checkBeforeTxn()
        {
            ...
            if (lvwEquipment.selectedMESItems.Length == 0)
            {
