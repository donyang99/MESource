    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            lvwEquipment.columnNames =
                "name,state,type,capacityUsed,capacity,reservedBy,owner,description,counter,lotId,recipe".Split(',');
            lvwEquipment.columnTags =
                "Equipment,state,EquipmentType,capacityUsed,capacity,eqReserve,owner,description,counter,lotId,recipe".Split(',');
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            mesRelease.EQP.Txn.EqReserve txn = new mesRelease.EQP.Txn.EqReserve();
            txn.reservedBy = cboOrderId.Text.Trim();
        ...
        bool checkBeforeTxn()
        {
            ...
            else if (eq.reservedBy.Equals(cboOrderId.Text.Trim()))
            {
                messageBox.showMessageById("msgRepeatValue");
                return false;
            }
        ...
        private void lvwEquipment_MESItemSelectionChanged(idv.messageService.itemBase item, ListViewItem listItem, bool selected)
        {
            ...
            {
                cboOrderId.Text = item.getPropertyInString("reservedBy");
            }
        }
