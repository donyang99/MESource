...
namespace ClientRule.TerminateLot
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            reasonCode1.Init("TerminateLot", "");

            if(currentLot != null && currentLot.equipmentId.Equals(""))
            {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            while (currentLot != null)
            {
                ...
                mesRelease.WIP.Txn.TerminateLot txn = new mesRelease.WIP.Txn.TerminateLot();
        ...
        bool CheckInputData(params Control[] ctrls)
        {
            ...
            foreach (Control ctrl in ctrls)
            {
                if(!validFail)
                {
                    if(ctrl.BackColor == SystemColors.Info && ctrl.Visible && ctrl.Text.Trim().Equals(""))
                        validFail = true;
                }
                else
                {
