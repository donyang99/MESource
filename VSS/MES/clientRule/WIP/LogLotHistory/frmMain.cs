...
namespace ClientRule.LogLotHistory
{
    public partial class frmMain : Form
    {
        ...
        void initAsynchronize()
        {
            try
            {
                reasonCode1.Init("LogLotHistory", "");
            }
            catch { }
        }
        ...
        bool checkBeforeTxn()
        {
            ...
            else if(reasonCode1.reasonCode.Equals("") && reasonCode1.comments.Equals(""))
            {
                standardStatusbar1.setInformation(cultureLanguage.getValue("requireField2", "&comments"), idv.mesCore.Controls.informationType.warn);
                return false;
            }
