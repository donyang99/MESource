    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
        ...
        private void PopupNotifierForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (Parent.ShowGrip)
            {
                ...
                e.Graphics.DrawImage(NotifiyWindow.Properties.Resources.Grip, (int)((this.Width - NotifiyWindow.Properties.Resources.Grip.Width) / 2), (int)((Parent.HeaderHeight - 3) / 2));
            }
            if (Parent.ShowCloseButton)
            {
                if (mouseOnClose)
