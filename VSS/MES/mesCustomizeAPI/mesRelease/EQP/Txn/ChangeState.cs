...
{
    /// <summary>
    /// state, capacityEffected, lotId, reasonCode, txnUser, txnDate. 
    /// state, txnUser is required
    /// </summary>
    public class ChangeState : changeState<ChangeState, Equipment, EquipmentHistory>
    {
